...
# Define paths ----------------------------------------------------------------
dir_input <- "indel/input/Realistic/"
dir_down_samp <- "indel_down_samp/input/10k/"
dir_non_hyper <- "indel_down_samp/input/non_hyper/"
...
spec_list$no_down_samp <- 
  ICAMS::ReadCatalog("indel/input/Realistic/ground.truth.syn.catalog.csv")
spec_list[["10k"]] <- 
  ICAMS::ReadCatalog("indel_down_samp/input/10k/ground.truth.syn.catalog.csv")
