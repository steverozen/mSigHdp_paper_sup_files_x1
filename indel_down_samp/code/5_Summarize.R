...
folder4ToolwiseSummary <- "./indel_down_samp/summary/toolwise_summary"
folder4CombinedSummary <- "./indel_down_samp/summary/top_level_summary"

# Specify dataset names
datasetNames <- c("500", "1k", "3k", "5k", "10k")
