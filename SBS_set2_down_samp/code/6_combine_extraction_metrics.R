...
# Please run 5_Summarize.R before running this code.
...
gtSigs <- paste0("SBS",c(1:6,paste0(7,letters[1:4]),8,9,
                         12,13,16,"17a","17b",18,22,26,
                         28:30,34:41,44))
nSigs <- length(gtSigs)


home <- "./SBS_2_down_samp/summary/top_level_summary/"
