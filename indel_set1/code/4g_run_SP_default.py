...
if __name__ == "__main__":
    ...
    home_for_data = os.path.abspath("./indel_set1/input")
    home_for_run = os.path.abspath("./indel_set1/raw_results")
    # Seed numbers
    ...
    # We set to 8..15 as there are 11 ground-truth signatures.
    min_K = 8
    max_K = 15
