...
if __name__ == "__main__":
    ...
    home_for_data = os.path.abspath("./indel_set2/input")
    home_for_run = os.path.abspath("./indel_set2/raw_results")
    # Seed numbers
    ...
    # We set to 10..17 as there are 13 ground-truth signatures.
    min_K = 10
    max_K = 17
...
if __name__ == "__main__":
    for dataset_name in dataset_names:
        for seed_number in seed_numbers:
            ...
            output_dir = "".join([home_for_run,"/SP_default.results/",
