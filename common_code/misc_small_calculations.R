...
sbsm <- glm(num_seeds_with_hit ~ sigs_prev_prop + Approach + dataset_name, data = s7x.sbs)


sbsr <- rlm(num_seeds_with_hit ~ sigs_prev_prop + Approach + dataset_name, data = s7x.sbs)
summary(sbsr)
